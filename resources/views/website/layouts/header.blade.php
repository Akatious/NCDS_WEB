        ...
        <div class="container px-0">
            <div class="topbar-top d-flex justify-content-between flex-lg-wrap">
                <div class="top-info flex-grow-0">
                    ...
                    <div class="overflow-hidden" style="width: 1000px;">
                        <div id="note" class="ps-2">
                            ...
                            <a href="#">
                                <p class="text-white mb-0 link-hover">
                                    NATIONAL COLLEGE OF DEFENCE STUDIES CONDUCTS EXPERIENTIAL RESEARCH STUDY TOUR -
                                    AFRICA
                                </p>
                            </a>
                        </div>
                        ...
                        <div class="navbar-nav mx-auto border-top">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                    <a href="{{ route('erstghana') }}" class="dropdown-item"
                                        style="text-transform:uppercase; font-weight:bold; ">ERST-ghana</a>
                                    <a href="{{ route('erstafrica') }}" class="dropdown-item"
                                        style="text-transform:uppercase; font-weight:bold; ">Erst-Africa</a>
                                    <a href="{{ route('cdsvisit') }}" class="dropdown-item"
                                        style="text-transform:uppercase; font-weight:bold; ">CDS-Visit
                                    </a>
                                </div>
                            </div>
                            <div class="nav-item dropdown">
